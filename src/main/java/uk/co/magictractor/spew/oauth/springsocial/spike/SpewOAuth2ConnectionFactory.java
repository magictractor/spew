...
public class SpewOAuth2ConnectionFactory extends GenericOAuth2ConnectionFactory {

    public SpewOAuth2ConnectionFactory(SpewOAuth2Configuration configuration) {
        super("TODO!",
