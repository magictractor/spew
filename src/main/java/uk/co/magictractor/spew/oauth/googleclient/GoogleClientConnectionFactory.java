 ...
 *
 */
public class GoogleClientConnectionFactory implements SpewConnectionFactory {
    ...
    public SpewConnection createConnection(SpewConnectionConfiguration configuration) {
        if (configuration instanceof SpewOAuth1Configuration) {
            return new GoogleClientOAuth1Connection((SpewOAuth1Configuration) configuration);
        }
        else if (configuration instanceof SpewOAuth2Configuration) {
            return new GoogleClientOAuth2Connection((SpewOAuth2Configuration) configuration);
        }
        return null;
    }
