package uk.co.magictractor.spew.local;

import static uk.co.magictractor.spew.local.ConvertedPhotoPropertiesSupplier.asInteger;
import static uk.co.magictractor.spew.local.ConvertedPhotoPropertiesSupplier.onlyElement;
