...
public abstract class AbstractAuthorizationHandler implements AuthorizationHandler {
    ...
    protected AbstractAuthorizationHandler(BiFunction<String, String, Boolean> verificationFunction) {
        this.verificationFunction = verificationFunction;
    }

    @Override
    public BiFunction<String, String, Boolean> verificationFunction() {
