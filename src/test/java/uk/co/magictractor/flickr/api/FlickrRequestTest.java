...
class FlickrRequestTest {
	...
	void testUrl() {
		...
		assertEquals("https://api.flickr.com/services/rest/?method=flickr.people.getPhotos&format=json",
				request.getUrl());
	}
	...
	void testSignatureBaseString() {
		FlickrRequest request = setUpExampleRequest();
		assertEquals(
	...
	private FlickrRequest setUpExampleRequest() {
		...
		// TODO! should not be escaped here?
		request.setParam("oauth_callback", "http%3A%2F%2Fwww.example.com");
